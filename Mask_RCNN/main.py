...
training_config_dict = {
    "train1": ["coco", "train", "Data/jr_train_val/train/train.json", "Data/jr_train_val/train"],
#    "train2": ["coco", "train2", "Data/train2/mod_init_jr_3.json", "Data/train2"]
}
testing_config_dict = {
    "test1": ["coco", "val", "Data/jr_train_val/val/val.json", "Data/jr_train_val/val"],
